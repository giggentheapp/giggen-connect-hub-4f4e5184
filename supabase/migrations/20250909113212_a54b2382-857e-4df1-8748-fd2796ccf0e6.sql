-- Fix booking status enum and update all references
...
WHERE status = 'both_parties_approved'::booking_status AND both_parties_approved IS NULL;
...
-- Update database function to handle new workflow
