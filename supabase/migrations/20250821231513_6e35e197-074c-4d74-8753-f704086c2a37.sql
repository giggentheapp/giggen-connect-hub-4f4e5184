-- Fix storage RLS policies - correct the folder index
...
-- File structure: {userId}/{filename} - userId is at index [0]
...
-- Create correct policies for portfolio bucket  
-- File structure: {userId}/{filename} - userId is at index [0]
...
-- Create correct policies for concepts bucket
-- File structure: {userId}/{filename} - userId is at index [0]
