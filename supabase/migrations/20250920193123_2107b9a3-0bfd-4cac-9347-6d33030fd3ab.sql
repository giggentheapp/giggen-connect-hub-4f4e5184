...
-- Fix search path for log_sensitive_booking_access function
...
-- Fix search path for can_access_contact_info function
...
-- Fix search path for get_secure_profile_data function
