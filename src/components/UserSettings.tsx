    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Kontroller hvem som kan se informasjonen din
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <Label>Vis adresse offentlig</Label>
              <p className="text-sm text-muted-foreground">
                La andre se din generelle lokasjon
              </p>
            </div>
            <Switch
              checked={profileData.is_address_public}
              onCheckedChange={(checked) => {
                setProfileData(prev => ({ ...prev, is_address_public: checked }));
                updateProfile({ is_address_public: checked });
              }}
            />
          </div>

          {profileData.is_address_public && (
            <div>
          ...
          {/* Maker-specific visibility settings */}
          {profile.role === 'maker' && profileSettings && (
            <>
              <div className="pt-4 border-t">
                <h4 className="font-medium mb-4">Maker-synlighet</h4>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <Label>Vis på kart</Label>
                      <p className="text-sm text-muted-foreground">Vises i kart-oversikten</p>
                    </div>
                    <Switch
                      checked={profileSettings.show_on_map}
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <Label>Vis "Om meg"</Label>
                      <p className="text-sm text-muted-foreground">Din bio og beskrivelse</p>
                    </div>
                    <Switch
                      checked={profileSettings.show_about}
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Telefon, e-post og nettside</p>
                    </div>
                    <Switch
                      checked={profileSettings.show_contact}
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <Label>Vis portefølje</Label>
                      <p className="text-sm text-muted-foreground">Dine arbeider og prosjekter</p>
                    </div>
                    <Switch
                      checked={profileSettings.show_portfolio}
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <Label>Vis arrangementer</Label>
                      <p className="text-sm text-muted-foreground">Kommende og tidligere arrangementer</p>
                    </div>
                    <Switch
                      checked={profileSettings.show_events}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Velg språk og varslingsinnstillinger
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label>Nye bookingforespørsler</Label>
                <p className="text-sm text-muted-foreground">Få beskjed når noen sender booking-forespørsel</p>
              </div>
              <Switch defaultChecked={true} />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label>Markedsføringsoppdateringer</Label>
                <p className="text-sm text-muted-foreground">Tips og nyheter fra GIGGEN</p>
              </div>
