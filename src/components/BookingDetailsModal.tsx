...
export const BookingDetailsModal = ({ isOpen, onClose, bookingId, currentUserId, isOwner = false }: BookingDetailsModalProps) => {
  ...
  const formatDate = (dateString: string) => {
    try {
      return format(new Date(dateString), 'EEEE d. MMMM yyyy', { locale: nb });
    } catch {
      return dateString;
    }
  };
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                {isOwner && (
                  <Badge variant="outline">Ditt arrangement</Badge>
                )}
              </div>
            </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {booking.time && booking.time !== 'Ved avtale' && (
                  <div className="flex items-center gap-3">
              ...
              {/* Venue */}
              {booking.venue && booking.venue !== 'Ved avtale' && (
                <div className="flex items-center gap-3">
              ...
              <CardContent className="pt-6">
                <div className="text-center space-y-4">
                  <p className="text-muted-foreground">
                    Interessert i dette arrangementet?
                  </p>
