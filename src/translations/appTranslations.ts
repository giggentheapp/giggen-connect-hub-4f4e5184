export const appTranslations = {
  no: {
    ...
    yourName: "Ditt navn",
    selectUserType: "Velg rolle",
    musiker: "Musiker",
    musikerDescription: "Jeg er musiker, artist eller soundsjekker",
    arrangør: "Arrangør",
    arrangørDescription: "Jeg arrangerer events, festivaler eller konserter",
    working: "Arbeider...",
    ...
    // Landing Page (moved from translations/index.ts)
    ...
    // Bookings Section - hardcoded texts
    bookings: {
      incomingRequests: "Innkommende forespørsler",
      sentRequests: "Sendte forespørsler",
      ongoingAgreements: "Pågående avtaler",
      upcomingEvents: "Kommende arrangementer",
      historicalBookings: "Historikk",
      ...
      noHistoricalBookings: "Ingen tidligere bookinger",
      seeDetails: "Se detaljer",
      seeOffer: "Se tilbud",
      noOfferAttached: "Ingen tilbud vedlagt",
      ...
      statusTexts: {
        ...
        allowedEditable: "Tillatt - kan redigeres",
        approvedBySender: "Godkjent av avsender",
        approvedByReceiver: "Godkjent av mottaker",
        approvedByBoth: "Godkjent av begge",
        published: "Publisert",
        completed: "Gjennomført",
        cancelled: "Avlyst"
      },
      phaseTexts: {
        receivedRequest: "Mottatt forespørsel",
        sentRequest: "Sendt forespørsel",
        negotiationPhase: "Forhandlingsfase - kan redigeres",
        approvedBySenderWaiting: "Godkjent av avsender - venter på mottaker",
        approvedByReceiverWaiting: "Godkjent av mottaker - venter på avsender",
        approvedByBothReady: "Godkjent av begge - klar for publisering",
        publishedEvent: "Publisert arrangement",
        completedEvent: "Gjennomført arrangement",
        cancelledEvent: "Avlyst arrangement",
  ...
  en: {
    ...
    yourName: "Your name",
    selectUserType: "Select role",
    musiker: "Musician",
    musikerDescription: "I am a musician, artist or sound engineer",
    arrangør: "Organizer",
    arrangørDescription: "I organize events, festivals or concerts",
    working: "Working...",
    ...
    bookings: {
      ...
      noHistoricalBookings: "No historical bookings",
      seeDetails: "See Details",
      seeOffer: "See Offer",
      noOfferAttached: "No offer attached",
      loadingBookings: "Loading Bookings...",
      couldNotUpdateList: "Could not update list",
      tryRefreshManually: "Try refreshing manually",
      statusTexts: {
        waitingForResponse: "Waiting for response",
        allowedEditable: "Allowed - Editable",
        approvedBySender: "Approved by sender",
        approvedByReceiver: "Approved by receiver",
        approvedByBoth: "Approved by both",
        published: "Published",
        completed: "Completed",
        cancelled: "Cancelled"
      },
      phaseTexts: {
        ...
        negotiationPhase: "Negotiation phase - editable",
        approvedBySenderWaiting: "Approved by sender - waiting for receiver",
        approvedByReceiverWaiting: "Approved by receiver - waiting for sender",
        approvedByBothReady: "Approved by both - ready for publishing",
